...
When a Slack thread uncovers a bug, decision, or task — create a Jira ticket
from it. Threads get buried; tickets don't.
...
Simply paste the Jira ticket URL into the thread and click on the "Sync thread"
button.
